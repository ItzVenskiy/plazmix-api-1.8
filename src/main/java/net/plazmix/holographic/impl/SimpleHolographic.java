...
public class SimpleHolographic implements ProtocolHolographic {
    ...
    @Override
    public void setLangHolographicLine(int lineIndex, BiFunction<Player, LocalizationResource, String> messageHandler) {
        setHolographicLine(lineIndex, new LangHolographicLine(lineIndex, messageHandler, this));
    }

    @Override
    public void setLangClickHolographicLine(int lineIndex, BiFunction<Player, LocalizationResource, String> messageHandler, Consumer<Player> clickAction) {
    ...
    @Override
    public void addLangHolographicLine(BiFunction<Player, LocalizationResource, String> messageHandler) {
        addHolographicLine(new LangHolographicLine(holographicLines.size(), messageHandler, this));
    }

    @Override
    public void addLangClickHolographicLine(BiFunction<Player, LocalizationResource, String> messageHandler, Consumer<Player> clickAction) {
