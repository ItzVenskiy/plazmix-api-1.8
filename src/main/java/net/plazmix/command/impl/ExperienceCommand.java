...
public class ExperienceCommand extends BaseMegaCommand<Player> {
    ...
    protected void help(Player player, String[] args) {
        checkPermission(player, tynixPlayer -> {
    ...
    protected void get(Player player, String[] args) {
        checkPermission(player, tynixPlayer -> {
            ...
            if (args.length == 0) {
                player.sendMessage("§d§lLeveling §8:: §fИспользуйте - §6/exp get <ник игрока>");
                return;
            }
    ...
    protected void give(Player player, String[] args) {
        checkPermission(player, tynixPlayer -> {
            ...
            if (args.length < 2) {
                player.sendMessage("§d§lLeveling §8:: §fИспользуйте - §6/exp add <ник игрока> <опыт>");
                return;
            }
    ...
    protected void take(Player player, String[] args) {
        checkPermission(player, tynixPlayer -> {
            ...
            if (args.length < 2) {
                player.sendMessage("§d§lLeveling §8:: §fИспользуйте - §6/exp take <ник игрока> <опыт>");
                return;
            }
    ...
    protected void set(Player player, String[] args) {
        checkPermission(player, tynixPlayer -> {
            ...
            if (args.length < 2) {
                player.sendMessage("§d§lLeveling §8:: §fИспользуйте - §6/exp set <ник игрока> <опыт>");
                return;
            }
