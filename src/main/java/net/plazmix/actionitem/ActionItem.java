...
public final class ActionItem {
    ...
    public static boolean hasActionItem(@NonNull ItemStack itemStack) {
        ...
        return ACTION_ITEM_MAP.containsKey(clone);
    }
    ...
    public static ActionItem fromItem(@NonNull ItemStack itemStack) {
        ...
        return ACTION_ITEM_MAP.get(clone);
    }
    ...
    public static ActionItem create(@NonNull ItemStack itemStack, Player... playersForGive) {
        ...
        if (!ActionItem.hasActionItem(itemStack)) {
            ...
            ACTION_ITEM_MAP.put(clone, actionItem);
        }
    ...
    private ActionItemHandler<ProjectileLaunchEvent> projectileLaunchHandler;

    private ActionItemHandler<ProjectileHitEvent> projectileHitHandler;
    ...
    public ActionItem setProjectileLaunchHandler(ActionItemHandler<ProjectileLaunchEvent> projectileLaunchHandler) {
        this.projectileLaunchHandler = projectileLaunchHandler;
        return this;
    }

    public ActionItem setProjectileHitHandler(ActionItemHandler<ProjectileHitEvent> projectileHitHandler) {
        this.projectileHitHandler = projectileHitHandler;
        return this;
    }
