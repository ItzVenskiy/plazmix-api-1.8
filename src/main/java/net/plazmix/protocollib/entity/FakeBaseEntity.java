...
public abstract class FakeBaseEntity implements Cloneable, FakeEntity {
    ...
    public static @NonNull FieldAccessor ENTITY_ID_ACCESSOR
            = Accessors.getFieldAccessor(MinecraftReflection.getEntityClass(),
            "entityCount", true);
    ...
    protected synchronized void sendTeleportPacket(@NonNull Player player) {
        ...
        PacketContainer packetContainer = teleportPacket.getHandle();
    ...
    protected synchronized void sendEntityLookPacket(@NonNull Player player) {
        ...
        PacketContainer packetContainer = entityLookPacket.getHandle();
    ...
    protected synchronized void sendHeadRotationPacket(@NonNull Player player) {
        ...
        PacketContainer packetContainer = headRotation.getHandle();

        packetContainer.getIntegers().write(0, entityId);
        packetContainer.getBytes().write(0, (byte) ((int) (location.getYaw() * 256.0F / 360.0F)));
    ...
    protected synchronized void broadcastDataWatcherObject(int dataWatcherIndex, @NonNull Object value) {
        getDataWatcher().setObject(dataWatcherIndex, value);
    ...
    public synchronized void setBurning(boolean burning) {
        ...
        broadcastDataWatcherObject(0, generateBitMask());
    }
    ...
    public synchronized void setCustomNameVisible(boolean customNameVisible) {
        ...
        broadcastDataWatcherObject(3, (byte) (customNameVisible ? 1 : 0));
    }

    @Override
    public synchronized void setNoGravity(boolean noGravity) {
        // no supported on 1.8 minecraft version.
    }
    ...
    public synchronized void setCustomName(@NonNull String customName) {
        ...
        broadcastDataWatcherObject(2, customName);
    }
    ...
    public synchronized void setCustomName(@NonNull Player player, @NonNull String customName) {
        ...
        wrappedDataWatcher.setObject(3, true);
    ...
    private synchronized byte generateBitMask() {
        return (byte) ((burning ? 0x01 : 0) + (sneaking ? 0x02 : 0) + (sprinting ? 0x08 : 0) + (invisible ? 0x20 : 0));
    }
