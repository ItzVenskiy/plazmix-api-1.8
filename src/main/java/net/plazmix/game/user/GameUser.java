...
public class GameUser {
    ...
    public static GameUser from(int playerID) {
        return GamePlugin.getInstance().getService().getGameUser(playerID);
    }

    public static GameUser from(@NonNull String playerName) {
        return GamePlugin.getInstance().getService().getGameUser(playerName);
    }

    public static GameUser from(@NonNull Player bukkitHandle) {
        return GamePlugin.getInstance().getService().getGameUser(bukkitHandle);
    }
